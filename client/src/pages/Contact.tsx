...
export default function Contact() {
  const whatsappNumber = "+233 276 885 358";
  const whatsappLink = "https://wa.me/233276885358";
        ...
        <div className="space-y-6">
          <Card className="border-primary/20">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-medium" data-testid="text-whatsapp-number">{whatsappNumber}</span>
              </div>
              ...
              <p className="text-sm text-muted-foreground text-center" data-testid="text-whatsapp-info">
          ...
          <div className="bg-muted/50 rounded-lg p-6 text-center">
            ...
            <p className="text-sm text-muted-foreground" data-testid="text-response-time">
              We typically respond within a few minutes on WhatsApp during business hours
            </p>
          </div>
        </div>
      </main>
